...
#define INCLUDED_fiesta_ui_events_WindowEvent
...
class HXCPP_CLASS_ATTRIBUTES WindowEvent_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x2910203f };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="fiesta.ui.events.WindowEvent")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"fiesta.ui.events.WindowEvent"); }
		...
		static  ::fiesta::ui::events::WindowEvent eventObject;
		static  ::Dynamic callback;
		static Dynamic callback_dyn() { return callback;}
		static void dispatch( ::fiesta::ui::events::WindowEvent event);
		static ::Dynamic dispatch_dyn();

		int height;
		 ::fiesta::ui::events::WindowEventType eventType;
		int width;
		int windowID;
		int x;
		int y;
...
#endif /* INCLUDED_fiesta_ui_events_WindowEvent */ 
