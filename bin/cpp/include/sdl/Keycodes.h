...
#define INCLUDED_sdl_Keycodes

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS1(sdl,Keycodes)
...
class HXCPP_CLASS_ATTRIBUTES Keycodes_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x07f7591a };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="sdl.Keycodes")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"sdl.Keycodes"); }
		...
		static hx::ObjectPtr< Keycodes_obj > __alloc(hx::Ctx *_hx_ctx) {
			Keycodes_obj *__this = (Keycodes_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Keycodes_obj), false, "sdl.Keycodes"));
		...
		::String __ToString() const { return HX_("Keycodes",c7,48,44,d5); }
