...
HX_LOCAL_STACK_FRAME(_hx_pos_dd4549ff8fa56c0b_500_ofString,"haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","/usr/local/lib/haxe/std/haxe/io/Bytes.hx",500,0xd68ef8f0)
namespace haxe{
namespace io{
...
bool Bytes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s, ::haxe::io::Encoding encoding){
            	HX_GC_STACKFRAME(&_hx_pos_dd4549ff8fa56c0b_500_ofString)
